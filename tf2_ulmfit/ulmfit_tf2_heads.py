...
from tf2_ulmfit.ulmfit_tf2 import tf2_ulmfit_encoder, HubRaggedWrapper, TiedDense, RaggedConcatPooler, ConcatPooler
...
def ulmfit_document_classifier(*, model_type, pretrained_encoder_weights, num_classes,
    ...
    fc1 = tf.keras.layers.Dense(50, activation='relu')(rpooler)
    #if with_batch_normalization is True:
    ...
    fc_final = tf.keras.layers.Dense(num_classes, activation=activation)(fc1)
    #fc_final = tf.keras.layers.Dense(num_classes, activation=activation)(fc1)
